...
class MaximumLimitException extends CoreException {
  ...
  @override
  String get code => generatedCode(code: ExceptionCode.maximumLimit.code);

  @override
  String get message => "Maximum Limit Exception";
